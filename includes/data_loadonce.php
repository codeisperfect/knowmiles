...
$_ginfo["query"]["myreviewreply"] = "select users.name, users.profilepic, comments.* from comments left join users on users.id = comments.uid where comments.bid={bid} and comments.type = 'c' order by id asc";
