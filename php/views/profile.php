    ...
    <div class="col-md-12 col-sm-12 know"><div class="tab-content span5">
        ...
        ?>
                                ...
                                <div class="col-md-12 col-sm-12 know"> <h2>Profile</h2></div>
                                  ...
                                  <div class="col-md-7 col-sm-7"><input type="email" name="email" placeholder="Email Id" value="<?php echo $myf["email"]; ?>" class="login-text profile-login" required></div>
                                  </div>
                                  <div class="row">
                                  <div class="col-md-5 col-sm-5 nan"><span>Mobile Number</span></div>
                                  <div class="col-md-7 col-sm-7"><input type="tel" name="phone" value="<?php echo $myf["phone"]; ?>" class="login-text profile-login" ></div>
                                  </div>
                                  <div class="row">
                                  <div class="col-md-5 col-sm-5 nan"><span>Address</span></div>
                                  <div class="col-md-7 col-sm-7"><input type="text" name="address" value="<?php echo Fun::displayMsgBody($myf["address"]); ?>" class="login-text profile-login" ></div>
                                  </div>
