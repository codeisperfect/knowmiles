			 ...
			 <div class="row reviewreplydiv" style='display:none;' >
				<div class="col-md-1 col-sm-1">
			 	...
			 	<div class="col-md-11 col-sm-11" >
					 ...
					 ?>
					 	<div>
					 		<form data-action='reviewcomment' onsubmit='if(form.valid.action1(this)){form.req(this);};return false;' method="post" data-res='obj.reset();div.load( $(obj).parent().prev()[0], 0, 0);' >
						 		<?php
						 			hidinp("bid", $row["id"]);
						 		?>
