...
<?php
	//print_r($_POST);
	$loc1 = 'Hauz Khas, New Delhi';
	$loc2 = 'Green Park, New Delhi';
	
	if( (isset($_POST['from'])) && (isset($_POST['city'])) )
	{
		$loc1 = $_POST['from'] . ', ' . $_POST['city'];
		
	}
		
	if( (isset($_POST['to'])) && (isset($_POST['city'])) )
	{
		$loc2 = $_POST['to'] . ', ' . $_POST['city'];
	}
?>
        ...
        GEvent.addListener(gDir, "load", function() 
								        {
								            ...
								            var resul = "fulloc1=" + location1.address + "&loc1lat=" + location1.lat + "&loc1lon=" + location1.lon + "&fulloc2=" + location2.address + "&loc2lat=" + location2.lat + "&loc2lon=" + location2.lon + "&dist=" + drivingDistanceKilometers + "&city=" + "<?php echo $_POST['city']; ?>";
                                            
								            window.parent.location.href = HOST."book.php?" + encodeURI(resul);
								        });
